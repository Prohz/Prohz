...
namespace KopkeHome_WebApp.Models
{
    public class UserViewModel
    {
        ...
        [Required(ErrorMessage = "First Name is required")]
        [StringLength(50, ErrorMessage = "Maximum 50 characters limit exceeded")]
        public string FirstName { get; set; }
        ...
        [Required(ErrorMessage = "Zip Code is required")]
        [StringLength(5, MinimumLength = 5, ErrorMessage = "Enter valid Zip Code")]
        public string ZipCode { get; set; }

        [Required(ErrorMessage = "Password is required")]
        [StringLength(16, MinimumLength = 8,
            ErrorMessage = "Password must be between 8 to 16 characters")]
        public string Password { get; set; }
        ...
        // -------------------------
        // TERMS (KEEP AS INT - your current system)
        // -------------------------
